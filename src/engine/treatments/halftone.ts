...
export const halftone: Treatment = {
  ...
  params: [
    { key: 'spacing', label: 'Screen', min: 8, max: 120, step: 1, default: 30, note: 'mark pitch, as % of stroke', primary: true },
    { key: 'scatter', label: 'Scatter', min: 0, max: 100, step: 1, default: 0, note: 'how far the marks wander off the grid', primary: true },
    { key: 'spray', label: 'Overspray', min: 0, max: 120, step: 1, default: 0, note: 'how far the haze carries past the edge', primary: true },
    { key: 'fade', label: 'Fade', min: 0, max: 100, step: 1, default: 0, note: 'thin the marks toward one end', primary: true },
    { key: 'size', label: 'Dot size', min: 15, max: 160, step: 1, default: 105, note: '100 just touches at full tone' },
    { key: 'fadeAngle', label: 'Fade direction', min: 0, max: 359, step: 1, default: 90, note: '90 fades toward the top' },
    { key: 'grain', label: 'Grain', min: 0, max: 100, step: 1, default: 100, note: 'the haze broken up, or smooth' },
    { key: 'fuse', label: 'Fuse', min: 0, max: 100, step: 1, default: 0, note: 'melt touching marks into blobs' },
    { key: 'angle', label: 'Angle', min: 0, max: 90, step: 1, default: 45, note: 'the classic screen sits at 45°' },
    { key: 'falloff', label: 'Falloff', min: 0, max: 100, step: 1, default: 60, note: 'how much smaller the dots get at the edge' },
    { key: 'solid', label: 'Keep the letter', min: 0, max: 100, step: 1, default: 0, note: 'ink left under the dots — 0 is dots alone' },
