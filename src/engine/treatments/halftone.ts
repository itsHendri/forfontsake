...
export const halftone: Treatment = {
  ...
  params: [
    ...
    { key: 'shape', label: 'Shape', group: 'Mark', min: 0, max: 1, step: 1, default: 0, note: 'the shape of every mark on the screen', kind: 'segment', options: ['Round', 'Square'] },
    ...
    { key: 'invert', label: 'Invert', group: 'Body', min: 0, max: 1, step: 1, default: 0, note: 'punch the dots out of the letter instead of drawing them', kind: 'switch' },
  ...
  presets: [
    ...
    { name: 'Fused blobs', values: { spacing: 45, size: 170, scatter: 0, spray: 25, angle: 45, falloff: 60, solid: 75, shape: 0, invert: 0, simplify: 0.4, fade: 0, fadeAngle: 90, grain: 0, fuse: 50 } },
