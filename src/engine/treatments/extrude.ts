...
export const extrude: Treatment = {
  ...
  params: [
    ...
    { key: 'pattern', label: 'Shape', group: 'Screen', min: 0, max: 1, step: 1, default: 0, note: 'what the screened shade is broken into — dots, or lines running along the throw', steady: true, kind: 'segment', options: ['Dots', 'Lines'] },
    { key: 'pitch', label: 'Pitch', group: 'Screen', min: 8, max: 80, step: 1, default: 30, note: '% of stroke width' },
    { key: 'layer', label: 'Layer', group: 'Face', min: 0, max: 3, step: 1, default: 0, note: 'which parts are drawn — the outline with its shade, the shade alone, the face alone, or a solid letter with its shade', steady: true, kind: 'segment', options: ['Outline', 'Shade', 'Face', 'Solid'] },
